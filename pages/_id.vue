                  ...
                  <div class="row"> -->
                    ...
                    <!-- <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3">
                      <div class="smallAuthorImageContainer">
                        <a href="#">
                          <img src="/product-images/harry_potter.jpg" class="img-fluid" />
                        </a>
                      </div>
                    </div> -->
                    <!-- Author's Name -->
                        ...
                        <span class="a-button-toggle">
                          <span class="a-button-inner">
                            <a href="#" class="a-button-text">
                              <span>Price</span>
                              <br />
                              <span class="a-color-secondary">Rs {{product.price}} /-</span>
                            </a>
                          </span>
                        </span>
                        ...
                        <span class="a-button-toggle">
                          <span class="a-button-inner">
                            <a href="#" class="a-button-text">
                              ...
                              <br />
                              <span class="a-color-secondary">{{product.stockQuantity}}</span>
                            </a>
                          </span>
                        </span>
                        <span class="tmm-olp-links"></span>
